...
```{r}
bodyF.model.all_red_1 <- lm(density ~ age + height + neck + chest + hip + thigh + forearm + wrist, data=bodyF.noWeight_noAbs)
bodyF.model.all_red_2 <- lm(density ~ age + chest + thigh + wrist, data=bodyF.noWeight_noAbs)
```
...
```{r}
bodyF.model.all_1 <- lm(density ~ age + weight + neck + abdomen + hip + thigh + forearm + wrist, data=bodyF)
bodyF.model.all_2 <- lm(density ~ weight + abdomen + forearm + wrist, data=bodyF)
```
...
```{r}
bodyF.model.for_red_1 <- lm(density ~ age + height + chest + hip + thigh + wrist, data=bodyF.noWeight_noAbs)
```
...
```{r}
bodyF.model.for_1 <- lm(density ~ age + weight + neck + abdomen + hip + thigh + biceps + forearm + wrist, data=bodyF)
```
...
```{r}
model.formula <- density ~ age + weight + neck + abdomen + hip + thigh + forearm + wrist
cv <- train(model.formula, data = bodyF, method = "lm", trControl = train.control)
cv$results$RMSE
```
